...
//               <InputLabel>Day From</InputLabel>
//               <Select
//                 value={timing.dayFrom}
//                 onChange={(e) => handleTimingChange(index, 'dayFrom', e.target.value)}
//               >
//                 {daysOfWeek.map((day) => (
...
//           <Grid item xs={12} sm={3}>
//             <FormControl fullWidth>
//               <InputLabel>Day To</InputLabel>
//               <Select
//                 value={timing.dayTo}
//                 onChange={(e) => handleTimingChange(index, 'dayTo', e.target.value)}
//               >
//                 {daysOfWeek.map((day) => (
//                   <MenuItem key={day} value={day}>
//                     {day}
...
//             <IconButton onClick={() => removeTiming(index)} aria-label="delete">
//               <Delete />
//             </IconButton>
//           </Grid>
//         </Grid>
