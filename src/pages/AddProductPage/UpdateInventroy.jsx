...
const UpdateInventroy = () => {
    ...
    try {
      ...
      setFormData({
        commonDetails: {
          ...
          manufactureOrPackerName:
            fetchedData.data.manufactureOrPackerName || "",
          manufactureOrPackerAddress:
            fetchedData.data.manufactureOrPackerAddress || "",
          commonOrGenericNameOfCommodity:
            fetchedData.data.commonOrGenericNameOfCommodity || "",
          monthYearOfManufacturePackingImport:
            fetchedData.data.monthYearOfManufacturePackingImport || "",
          importFSSAILicenseNo: fetchedData.data.importFSSAILicenseNo || "",
          brandOwnerFSSAILicenseNo:
            fetchedData.data.brandOwnerFSSAILicenseNo || "",
 ...
 console.log("timing",formData.commonDetails.timing);
        ...
        <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
          ...
          >
            ...
            <div style={{ marginBottom: "16px" }}>
              <Typography variant="h6" align="center"   sx={{ fontWeight: 'bold' }} > UPDATE PRODUCT</Typography>
            </div>
            <div
              style={{
                marginBottom: "16px",
            ...
            />
                ...
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth required>
                    <InputLabel id="return-window-label">
                      Return Window
                    </InputLabel>
                    <Select
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    value={
                      formData.commonDetails.commonOrGenericNameOfCommodity
                    }
                    onChange={handleChange}
                    required
                    fullWidth
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    value={
                      formData.commonDetails.monthYearOfManufacturePackingImport
                    }
                    onChange={handleChange}
                    required
                    fullWidth
